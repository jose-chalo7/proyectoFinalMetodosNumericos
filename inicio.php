      ...
      <ul class="navbar-nav ms-auto">
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
            <li><a class="dropdown-item" href="#">Metodo Newton Raphson</a></li>
            <li><a class="dropdown-item" href="#">Metodo Secante</a></li>
            <li><a class="dropdown-item" href="#">Metodo Muller</a></li>
            <li><a class="dropdown-item" href="#">Metodo Gauss</a></li>
          </ul>
          <li class="nav-item">
          <a class="nav-link" aria-current="page" href="servidor/login/logout.php">Cerrar Sesion</a>
        </li>
        </li>
      </ul>
    </div>
